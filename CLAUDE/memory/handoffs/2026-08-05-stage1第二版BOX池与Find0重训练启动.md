...
- 17:27，用户因吞吐过慢主动 `scancel 336558`，并明确要求不再监控该unet_c1。Slurm最终为CANCELLED；最终摘要step3668，第二次验证配体体素PRAUC0.343178，TOP0.3432与last完整，BEST仍为上一轮0.2537 TOP。不得恢复、接管或重提Job336558，后续heartbeat只监控Find_0。
- 21:34，Find_0 attempt a4推进到step5426，五项训练损失有限；第三次验证、TOP0.5527与last完整，BEST正确对应上一轮0.5116 TOP。双H100使用80.85/80.83GiB，W&B、正式进程、唯一after_lock正常，无OOM或异常。
- 2026-08-07 13:37，Find_0 attempt a4推进到step7853并已完成第四、第五次验证。最新验证总损失0.327828，配体体素/受体/原子/伪原子PRAUC为0.560720/0.636979/0.640433/0.588258；中间TOP0.5284、新TOP0.5607与last完整，BEST正确刷新到上一轮最佳0.5527 TOP。双H100使用80.89/80.84GiB，W&B、正式进程、唯一after_lock正常，当前日志无OOM、警告或异常。
- 2026-08-07 16:40，Find_0 attempt a4推进到step8468，五项训练损失有限；最新第五次验证、TOP0.5607、last与对应上一轮最佳0.5527 TOP的BEST保持完整，尚无第六次验证。双H100使用80.78/80.87GiB，作业RUNNING且只有after_lock，W&B与正式进程持续活动，当前日志无OOM、警告或异常。
- 2026-08-07 19:38，Find_0 attempt a4推进到step8768，五项训练损失有限；第五次验证、TOP0.5607、last与对应上一轮最佳0.5527 TOP的BEST保持完整，尚无第六次验证。双H100均使用80.88GiB，作业RUNNING且只有after_lock，W&B与正式进程持续活动，当前日志无OOM、警告或异常。
- 2026-08-07 22:40，Find_0 attempt a4推进到step9299并完成第六次验证：总验证损失0.327025，配体体素/受体/原子/伪原子PRAUC为0.562431/0.628463/0.643336/0.600575；新TOP0.5624与last完整，BEST正确刷新到上一轮最佳0.5607 TOP。双H100使用80.36/80.27GiB，作业RUNNING且只有after_lock，W&B与正式进程正常，当前日志无OOM、警告或异常。
- 2026-08-08 01:40，Find_0 attempt a4推进到step9920，五项训练损失有限；第六次验证、TOP0.5624、last与对应上一轮最佳0.5607 TOP的BEST保持完整，尚无第七次验证。双H100使用80.72/79.50GiB，作业RUNNING且只有after_lock。W&B上传出现一次可重试HTTP 408，但摘要、事件、内部日志和训练持续更新且dropped=0；无OOM、未处理异常或训练阻断。
- 2026-08-08 04:40，Find_0 attempt a4推进到step10229，五项训练损失有限；第六次验证、TOP0.5624、last与对应上一轮最佳0.5607 TOP的BEST保持完整，尚无第七次验证。双H100使用80.68/80.25GiB，作业RUNNING且只有after_lock；W&B与正式进程持续活动，上一轮HTTP 408未继续出现，当前日志无OOM、警告或异常。
- 2026-08-08 07:41，Find_0 attempt a4推进到step10715并完成第七次验证：总验证损失0.309085，配体体素/受体/原子/伪原子PRAUC提升到0.576889/0.661014/0.669940/0.605355；新TOP0.5769与last完整，BEST正确刷新到上一轮最佳0.5624 TOP。双H100使用80.82/80.43GiB且满载计算，作业RUNNING且只有after_lock，W&B与正式进程正常，当前日志无OOM、警告或异常。
- 2026-08-08 10:41，Find_0 attempt a4推进到step11315，五项训练损失有限；第七次验证、TOP0.5769、last与对应上一轮最佳0.5624 TOP的BEST保持完整，尚无第八次验证。双H100使用80.43/80.27GiB，作业RUNNING且只有after_lock，W&B与正式进程正常，当前日志无OOM、警告或异常。
- 2026-08-08 13:41，Find_0 attempt a4推进到step11690，五项训练损失有限；第七次验证、TOP0.5769、last与对应上一轮最佳0.5624 TOP的BEST保持完整，尚无第八次验证。双H100使用79.98/80.36GiB，作业RUNNING且只有after_lock，W&B与正式进程正常，当前日志无OOM、警告或异常。
- 2026-08-08 16:41，Find_0 attempt a4推进到step12089并完成第八次验证：总验证损失0.304401，配体体素/受体/原子/伪原子PRAUC为0.566803/0.659098/0.667087/0.625045；配体体素PRAUC未超过当前最佳0.576889。新TOP0.5668与last完整，BEST正确刷新到全局最佳0.5769 TOP。双H100使用80.88/80.75GiB，作业RUNNING且只有after_lock，W&B与正式进程正常，当前日志无OOM、警告或异常。
- 2026-08-08 19:42，Find_0 attempt a4推进到step12734，五项训练损失有限；第八次验证、TOP0.5668、last与当前全局最佳0.5769 TOP的BEST保持完整，尚无第九次验证。双H100使用80.74/80.65GiB，作业RUNNING且只有after_lock，W&B与正式进程正常，当前日志无OOM、警告或异常。
- 2026-08-08 23:21，Find_0 attempt a4推进到step13151，五项训练损失有限；第八次验证、TOP0.5668、last与当前全局最佳0.5769 TOP的BEST保持完整，尚无第九次验证。双H100使用80.77/80.61GiB，作业RUNNING且只有after_lock，W&B与正式进程正常，当前日志无OOM、警告或异常。
- 2026-08-09 01:45，Find_0 attempt a4推进到step13553并完成第九次验证：总验证损失0.309025，配体体素/受体/原子/伪原子PRAUC为0.587031/0.654145/0.658401/0.604590；配体体素PRAUC创下新高。新TOP0.5870与last完整，BEST仍对应上一轮全局最佳0.5769 TOP，等待下一次验证刷新。双H100使用80.82/80.91GiB，作业RUNNING且只有after_lock，W&B与正式进程正常，当前日志无OOM、警告或异常。
- 2026-08-09 04:46，Find_0 attempt a4推进到step14129，五项训练损失有限；第九次验证、TOP0.5870与last保持完整，尚无第十次验证。BEST仍对应上一轮全局最佳0.5769 TOP，等待验证边界刷新。双H100使用80.86/78.38GiB，作业RUNNING且只有after_lock，W&B与正式进程正常，当前日志无OOM、警告或异常。
- 2026-08-09 07:46，Find_0 attempt a4推进到step14612，五项训练损失有限；第九次验证、TOP0.5870与last保持完整，尚无第十次验证。BEST仍对应上一轮全局最佳0.5769 TOP，等待验证边界刷新。双H100使用79.89/80.17GiB，作业RUNNING且只有after_lock，W&B与正式进程正常，当前日志无OOM、警告或异常。
- 2026-08-09 10:45，Find_0 attempt a4推进到step14858并完成第十次验证：总验证损失0.310329，配体体素/受体/原子/伪原子PRAUC为0.594641/0.668659/0.678753/0.609944；前三项PRAUC创下新高。新TOP0.5946与last完整，BEST已按一次验证延迟刷新到上一轮最佳0.5870 TOP。双H100使用80.66/80.78GiB，作业RUNNING且只有after_lock，W&B与正式进程正常，当前日志无OOM、警告或异常。
- 2026-08-09 13:47，Find_0 attempt a4推进到step15431，五项训练损失有限；第十次验证、TOP0.5946、last与对应上一轮最佳0.5870 TOP的BEST保持完整，尚无第十一次验证。双H100使用80.88/79.76GiB，作业RUNNING且只有after_lock，W&B与正式进程正常；当前只有既有批量大小推断提示，无OOM或未处理异常。
...
- 2026-08-10 18:34，Find_0 attempt a4推进到step19814，五项训练损失有限；第十三次验证、TOP0.6105、last与对应上一轮最佳TOP0.6012的BEST保持完整，尚无第十四次验证。正式进程继续使用release Pocket_Plus_dc0f05168815与原batch6/global48契约。双H100使用78.13/78.90GiB，作业RUNNING且只有after_lock，W&B持续更新，当前错误扫描为空。
- 2026-08-11 00:35，累计检查确认Find_0 attempt a4先健康推进至step20381，随后在step20564完成第十四次验证：总验证损失0.296780，配体体素/受体/原子/伪原子PRAUC为0.602808/0.672384/0.665802/0.625006，未超过现有配体体素最佳0.610505。新TOP0.6028与last完整，BEST已刷新到全局最佳TOP0.6105；top-k保留策略移除最弱TOP0.5527。双H100使用79.06/78.89GiB，作业RUNNING且只有after_lock，W&B持续更新，无OOM或未处理异常。
- 2026-08-11 09:36，累计检查确认Find_0 attempt a4在两轮例行检查中健康推进至step21803，随后在step22004完成第十五次验证：总验证损失刷新为新低0.290471，受体/原子/伪原子PRAUC刷新为新高0.687456/0.687093/0.644783；配体体素PRAUC为0.591634，未超过现有最佳0.610505。新TOP0.5916与last完整，BEST继续指向全局最佳TOP0.6105；top-k保留策略移除最弱TOP0.5607。双H100使用78.87/79.08GiB，作业RUNNING且只有after_lock，W&B持续更新，无OOM或未处理异常。
- 2026-08-11 19:47，累计检查确认Find_0 attempt a4在两轮例行检查中健康推进至step23381，随后在step23651完成第十六次验证：总验证损失刷新为新低0.284102，配体体素/受体/原子/伪原子PRAUC均刷新为新高0.613022/0.697511/0.702683/0.661703。新TOP0.6130与last完整，BEST按一次验证延迟继续指向上一轮全局最佳TOP0.6105；top-k保留策略移除最弱TOP0.5624。双H100使用78.74/79.03GiB，作业RUNNING且只有after_lock，W&B持续更新，无OOM或未处理异常。
