# 平移模拟密度并验证 CC 下降的命令入口。
# 实际逻辑：调用 Chimera 适配和 Stage F 模块，比较正确配对与错位密度图的相关系数。
...
from adaligand_preprocessing.ops.smoke_checks import NEGATIVE_CC_FIELDS, negative_cc_errors, shift_grid_x_no_wrap
