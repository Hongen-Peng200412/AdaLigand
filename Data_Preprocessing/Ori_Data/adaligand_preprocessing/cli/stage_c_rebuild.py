# Stage C 来源重建的 audit/apply 命令入口。
# 实际逻辑：调用 Stage C 来源重建模块，执行审计、准备、迁移清单与受检提交。
...
from adaligand_preprocessing.ops.stage_c_repair import verify_audit_inputs_unchanged
