...
from adaligand_preprocessing.stages.stage_c.constants import (
    JUNK_RESNAMES,
    METAL_ELEMENTS,
    NUCLEIC_BACKBONE,
    PROTEIN_BACKBONE,
)
from adaligand_preprocessing.utils.io import atomic_save_npz, file_lock, safe_object_filename, write_jsonl
from adaligand_preprocessing.stages.stage_c.descriptors import materialize_ligand_descriptor
...
from adaligand_preprocessing.stages.stage_c.receptor import build_receptor_arrays, build_receptor_base_arrays
...
def parse_one_pdb(root: Path, pdb_id: str, overwrite: bool) -> dict[str, Any]:
    ...
    if not overwrite:
        from adaligand_preprocessing.stages.stage_c.contracts import CArtifactState, inspect_stage_c
        ...
        if inspection.state == CArtifactState.UPGRADE:
            from adaligand_preprocessing.stages.stage_c.upgrades import upgrade_stage_c
