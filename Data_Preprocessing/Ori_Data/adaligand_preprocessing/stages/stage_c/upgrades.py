...
def upgrade_receptor_tokens(root: Path, pdb_id: str) -> bool:
    ...
    from adaligand_preprocessing.stages.stage_c.pipeline import category_rows, optional_category_rows, selected_atom_rows, split_candidate_atoms
