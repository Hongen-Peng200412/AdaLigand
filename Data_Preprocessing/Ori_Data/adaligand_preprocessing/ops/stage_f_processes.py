"""生成并校验 Stage F scratch 回收前的零进程证据。"""
...
_STAGE_F_TOKENS = (
    "f_quality.py",
    "adaligand_preprocessing.cli.stage_f",
    "popen_loky",
    "loky.backend",
    "lokyprocess",
    "/chimera",
...
_RECOVERY_TOKENS = (
    ...
    "stage_f_scratch.py",
    "adaligand_preprocessing.cli.stage_f_scratch",
    "stage_f_scratch_recovery_20260716",
    "adaligand_stage_f_inventory",
    ".adaligand_stage_f_inventory",
    "stage_f_process_audit.py",
    "adaligand_preprocessing.cli.stage_f_process_audit",
