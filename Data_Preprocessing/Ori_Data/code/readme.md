...
- 上文“双 CPU96 继续运行”是 Phase-2 前的历史状态。补算 v2 首轮曾完成 5,984 行 unique：2,984 skipped + 2,986 success + 6 known + 8 unknown，status SHA-256 `3231dfe5…23e`，且因 unknown 未形成 `f_supplement_release`。已 release 的补算 v1 status/release SHA-256 `04d6474e…39a7` / `9a445fa4…9426` 与 Stage E base4 `380844d0…325f` 始终冻结。Phase-2 现已完成 formal 11→19 与 v2 6→14 的原子迁移；结果证据 SHA-256 为 `1baccec0…9644`，两次独立只读审计均通过。正式 `316116/cnode04` 继续保持 after+try、零 F writer；`318350/cnode01` 已在原 CPU96 allocation 以 F12/no-overwrite 重放补算 v2，完成 gate 前不得释放正式 F。scratch v4 早已闭合，不得因这个新停点重复执行。
